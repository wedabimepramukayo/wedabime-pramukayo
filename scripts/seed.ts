...
async function main() {
  ...
  const settings = [
    ...
    { key: "primary_color", value: "#2D6A4F", category: "theme", description: "Primary brand color (Forest Green — Trust & Authority)" },
    { key: "secondary_color", value: "#1B4332", category: "theme", description: "Secondary brand color (Deep Forest — Stability)" },
    { key: "accent_color", value: "#7DD857", category: "theme", description: "Accent brand color (Spring Green — Innovation & Energy, from logo)" },
    { key: "emerald_color", value: "#40916C", category: "theme", description: "Emerald (Vitality & Balance)" },
    { key: "teal_green_color", value: "#53C275", category: "theme", description: "Teal-Green (Sophistication, from logo)" },
    { key: "lime_color", value: "#68CB66", category: "theme", description: "Lime (Freshness, from logo)" },
    { key: "sage_color", value: "#95D5B2", category: "theme", description: "Sage (Calm Reassurance)" },
    { key: "mint_color", value: "#D8F3DC", category: "theme", description: "Mint (Clean & Eco)" },
    { key: "gold_color", value: "#D4A843", category: "theme", description: "Gold (Premium Value & Warranty)" },
